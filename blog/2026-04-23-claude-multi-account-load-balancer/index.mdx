...
```bash
git clone https://github.com/ArcsHealth/claude-multi.git
cd claude-multi
./install.sh
```
...
*Tools used: [Claude Code](https://claude.ai/download) by Anthropic, [Bun](https://bun.sh/) by Oven. Source code: [claude-multi](https://github.com/ArcsHealth/claude-multi).*
