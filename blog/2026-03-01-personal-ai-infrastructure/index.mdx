...
Previous posts covered project-level skills. User-level skills live in `~/.claude/skills/` (deployed via [claude-config](https://github.com/RooseveltAdvisors/pai-claude-config)) and are available in every project, on every machine.
...
*Tools used: [Claude Code](https://claude.ai/download) by Anthropic, [Bun](https://bun.sh) runtime for hooks, [GitHub Actions](https://docs.github.com/en/actions) for CI/CD. Source: [RooseveltAdvisors/pai-claude-config](https://github.com/RooseveltAdvisors/pai-claude-config).*
