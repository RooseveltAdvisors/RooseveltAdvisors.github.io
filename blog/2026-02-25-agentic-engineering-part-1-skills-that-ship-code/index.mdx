...
I run a healthcare portal — patient registration, scheduling, telehealth, insurance OCR. When a bug ships, real people can't see their doctor. So I needed more than "be careful" — I needed a system.
...
| `/PortalCleanupTestData` | Reset test patient data between runs |
