...
I created a git repository — [claude-config](https://github.com/RooseveltAdvisors/pai-claude-config) — that contains everything that should live in `~/.claude`:
...
*Tools used: [Claude Code](https://claude.ai/download) by Anthropic, [GitHub Actions](https://docs.github.com/en/actions) for CI/CD, [CodeRabbit](https://coderabbit.ai) for automated PR review. Source: [RooseveltAdvisors/pai-claude-config](https://github.com/RooseveltAdvisors/pai-claude-config).*
