...
## What I Built: OneContext

[OneContext](https://github.com/RooseveltAdvisors/OneContext) is my open-source implementation. It's ~2,600 lines of Python, structured in four layers:
...
OneContext is open source: [github.com/RooseveltAdvisors/OneContext](https://github.com/RooseveltAdvisors/OneContext)

```bash
git clone https://github.com/RooseveltAdvisors/OneContext
cd OneContext && bash install.sh
```
