...
The [pai-claude-config](https://github.com/RooseveltAdvisors/claude-agent-stack) repo is PAI plus three things:
...
The private repo has private details — machine names, network config, service-specific skills. The [public version](https://github.com/RooseveltAdvisors/claude-agent-stack) strips all of that and keeps what's universally useful: the CLAUDE.md template, a sanitized deploy.sh, and 27 skills that work in any context.
